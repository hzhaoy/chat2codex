...
export type PermissionApprovalCardStatus =
  | "pending"
  | "resolved"
  | "declined"
  | "cancelled"
  | "expired";
export type McpElicitationCardStatus =
  | "pending"
  | "resolved"
  | "declined"
  | "cancelled"
...
export type PermissionApprovalCardRequest = Pick<
  CodexPermissionApprovalRequest,
  "id" | "cwd" | "permissions"
> &
  Partial<
...
export interface PermissionApprovalCardInput {
...
export type McpElicitationCardRequest = CodexMcpElicitationRequest;

export interface McpElicitationCardInput {
  status: McpElicitationCardStatus;
  request: McpElicitationCardRequest;
  updatedAt: string;
  replyCode?: string;
  /** Only field ids are needed to render progress; answer values must not be passed to cards. */
